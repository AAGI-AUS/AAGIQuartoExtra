...
[![Lifecycle: experimental](https://img.shields.io/badge/lifecycle-experimental-orange.svg)](https://lifecycle.r-lib.org/articles/stages.html#experimental) [![R-CMD-check](https://github.com/AAGI-AUS/AAGIQuartoExtra/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/AAGI-AUS/AAGIQuartoExtra/actions/workflows/R-CMD-check.yaml)
...
AAGIQuartoExtra is available through the [R-Universe](https://r-universe.dev/search) with pre-built binaries (this is the easy way).
