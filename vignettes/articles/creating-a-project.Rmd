...
Based on the proposed structure, we should have all documents (e.g. PDF, DOCX, HTML, or PPTX files) stored within the /doc folder. The `setup_docs()` function helps organize your initial `index.qmd` and `_quarto.yml` files by renaming and updating their configuration.
